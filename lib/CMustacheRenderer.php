<?php
/**
 * Implementation of the `CMustacheRenderer` class.
 * @module CMustacheRenderer
 */
Yii::setPathOfAlias('mustache', __DIR__);
Yii::import('mustache.*');

/**
 * View renderer allowing to use the [Mustache](http://mustache.github.io) template syntax.
 * @class CMustacheRenderer
 * @extends CApplicationComponent
 * @constructor
 */
class CMustacheRenderer extends CApplicationComponent implements IViewRenderer {
  ...
  public function init() {
    ...
    $options=[
      ...
      'escape'=>[ 'CHtml', 'encode' ],
      'helpers'=>CMap::mergeArray([ 'app'=>Yii::app() ], $this->helpers),
    ...
    if($this->enableCaching) {
      $cache=Yii::createComponent([
        ...
        'cachePath'=>Yii::app()->runtimePath.'/views'
      ]);
